...
class ListMapListAccessorWriter(ListAccessorWriter):
	...
	def write_dict_list_getter_function(self):
		self.f.write(
			'\tdef {}(self, redis, id_string):\n'.format(
				self.get_dict_list_getter_function_name()
				)
			)
		self.f.write(
	...
	def get_dict_list_getter_function_name(self):
		return 'get_{}_dict_list'.format(self.table_desc['table_name'])
		
	def write_adder_function(self):
		self.f.write('\tdef {}(self, redis, id_string, {}_string, d):\n'.format(
