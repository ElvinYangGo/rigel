...
class CenterStartServerInitResponseHandler(StartServerInitResponseHandler):
	def __init__(self):
		pass
	...
	def handle_message(self, message_id, channel_buffer, **kwargs):
		...
		GlobalData.instance.rmq.send_message_string(message, ChannelName.SERVER_INITIALIZATION, ProtocolID.END_SERVER_INIT_NOTIFICATION)
