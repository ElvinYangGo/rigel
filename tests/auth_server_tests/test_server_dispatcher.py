...
class ServerDispatcherTest(unittest.TestCase):
	...
	def test_contain_server(self):
		...
		self.server_dispatcher.add_server('sa', ServerType.GATEWAY_SERVER, ServerStatus.SERVER_STATUS_RUNNING)
	...
	def test_dispatch_server(self):
		self.server_dispatcher.add_server('sa', ServerType.GATEWAY_SERVER, ServerStatus.SERVER_STATUS_RUNNING)
		self.server_dispatcher.add_server('sb', ServerType.GATEWAY_SERVER, ServerStatus.SERVER_STATUS_RUNNING)
		self.server_dispatcher.add_server('sc', ServerType.GATEWAY_SERVER, ServerStatus.SERVER_STATUS_RUNNING)
